...
import com.imad.springAuthServer.DTO.errorResponse;
...
public class globalExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<errorResponse> handleNameExists(clientAlreadyExists clientAlreadyExists, WebRequest webRequest){
