...
import com.micro.studentService.DTO.errorResponse;
...
public class globalExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<errorResponse> handleNameExists(studentExists studentExists, WebRequest webRequest){
